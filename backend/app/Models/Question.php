...
class Question extends Model
{
    ...
    /**
     * As 11 perguntas do "Diagnóstico de Maturidade e Crescimento do
     * Escritório" — única fonte de verdade, usada tanto pelo seeder inicial
     * (DatabaseSeeder → QuestionSeeder, banco novo) quanto pelo reset manual
     * (QuestionController::resetDefaults()), pra nunca mais divergirem.
     *
     * Só as perguntas 3-7 (`scored: true`) compõem o score de maturidade —
     * ver `App\Services\DiagnosisEngine`. As de `category_slug` igual a
     * `intencao_compra`/`fit_investimento` (10 e 11) são exibidas pelo
     * frontend na tela de qualificação, depois do resultado — não durante o
     * quiz inicial.
     */
